...
import { FIREX_DOCUMENT_UNSUBSCRIBER, FIREX_COLLECTION_UNSUBSCRIBER } from '../../../../src/v1-alpha/configurations'
...
describe('FirestoreFetcher', () => {
  it('unsubscribe document called', () => {
    ...
    FirestoreUnsubscriber
      .unbind('document')
      .unsubscribe({ [FIREX_DOCUMENT_UNSUBSCRIBER]: mockUnsubscriber })
  ...
  it('unsubscribe collection called', () => {
    ...
    FirestoreUnsubscriber
      .unbind('collection')
      .unsubscribe({ [FIREX_COLLECTION_UNSUBSCRIBER]: mockUnsubscriber })
